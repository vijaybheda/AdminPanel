...
public class NewDoctor extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextName = findViewById(R.id.edt_drfname);
        editTextdob = findViewById(R.id.edt_drdob);
        editTextdob.setOnClickListener(this);
        AutoCompleteTextView cities = findViewById(R.id.edt_drcity);
        spinner = findViewById(R.id.spinner_drspeciality);
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this,
                android.R.layout.select_dialog_item, ArraylistOfCities);
