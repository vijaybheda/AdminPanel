...
public class NewFS extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextName = findViewById(R.id.edt_fsfname);
        editTextDOB = findViewById(R.id.edt_fsdob);
        spinner = findViewById(R.id.spinner_fsspeciality);
        AutoCompleteTextView cities = findViewById(R.id.edt_fscity);
